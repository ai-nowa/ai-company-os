...
| creative routine | sonnet / high | gpt-5.5 / high | 編集/People/視聴者代表の企画・仮説・雑談発見は shallow にしない。 |
| real conversation | sonnet / high | gpt-5.5 / high | 人間/社員同士の文脈は雑に返すと会社感が崩れる。 |
| work | sonnet / high | gpt-5.5 / high | 実装、設計、台本、レビュー。 |
| risk review | opus / xhigh | gpt-5.5 / xhigh | 権限、認証、秘密、公開、決済、削除、本番、外部投稿は事故コストが高い。 |
...
- 危険語彙（権限/認証/秘密/公開/決済/削除/本番/外部投稿）は、P0でなくても `risk_review` として Opus に上げる。
- 企画・台本・雑談発見・視聴者判断は `creative_routine` として high に上げる。
